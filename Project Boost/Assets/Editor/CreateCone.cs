...
public class CreateCone: ScriptableWizard {
    ...
    [SerializeField] int numVertices = 10;
    [SerializeField] float radiusTop = 0f;
    [SerializeField] float radiusBottom = 1f;
    [SerializeField] float length = 1f;
    [SerializeField] float openingAngle = 0f; // if >0, create a cone with this angle by setting radiusTop to 0, and adjust radiusBottom according to length;
    [SerializeField] bool outside = true;
